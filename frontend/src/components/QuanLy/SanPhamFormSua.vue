         ...
         <div class="row container-fluid">
             <div class="col-md-6">
                 ...
                 <div class="form-group">
                     ...
                     <Field v-if="!chonDanhMuc" name="ID_Catalog" type="name" class="form-control" v-model="sanphamLocal.DM_Ten" @click="chonDanhMuc=true"/>
                 ...
                 <div class="form-group">
                     ...
                     <Field v-if="!chonThuongHieu" name="ID_Branch" type="name" class="form-control" v-model="sanphamLocal.TH_Ten" @click="chonThuongHieu=true"/>
